    ...
    <div class="widget widget_tt_popular_post">
        <div class="tt-popular-post border-bottom-tab">
            ...
            <ul class="nav nav-tabs">
                <li class="active">
                    <a href="#tt-popular-post-tab1" data-toggle="tab" aria-expanded="true">{{ trans('blog::post.title.recent posts') }}</a>
                </li>
                <li class="">
                    <a href="#tt-popular-post-tab2" data-toggle="tab" aria-expanded="false">{{ trans('blog::post.title.popular posts') }}</a>
                </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div id="tt-popular-post-tab2" class="tab-pane fade">
                    ...
                    @foreach(Blog::popular(5) as $popular)
                        <div class="media">
                            <a class="media-left" href="#">
